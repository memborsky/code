...
/**
* Require the exception class for Postgre
*/
require_once('extensions/Error_Handler/class.Postre_Exception.php');

/**
* Database access tools
*
* Abstraction layer for accessing Postgre databases
*
* @package DB
* @access public
* @author Tim Rupp <tarupp01@indianatech.net>
...
class DB {
	...
	*/
	...
	/**
	* Server IP address where Postgre database resides
	*
	* @access protected
	* @var string
	*/
	...
	*/
	public function __construct ($username, $password, $db, $server = "localhost", $port = 3306) {
		...
		*/
		...
		/**
		* If the user specified a non-standard port for the Postgre connection, we need
	...
	*/
	...
	/**
	* Creates a connection to a Postgre database
	*
	...
	* the connection to the Postgre database server.
