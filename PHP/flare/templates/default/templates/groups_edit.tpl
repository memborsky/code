            ...
            <table style='width: 100%;'>
                ...
                <tr>
                    <td style='vertical-align: top;'>
                        <span style='font-weight: bold;'>{$_GROUPS_CUR_SHARE_AMNT}</span>
                        <p />
                        {$_GROUPS_SHARE_AMNT_MESG}
                    </td>
                    <td style='vertical-align: top;'>
                        <input type='hidden' name='old_share_amount' value='{$SHARE_AMOUNT}'>
                        <input type='text' name='new_share_amount' value='{$SHARE_AMOUNT}' size='10' maxlength='10' class='input_txt'> Megabytes. You have {$TOTAL_QUOTA_REMAINING} Megabytes available that you can share.
                    </td>
                </tr>
                <tr>
                    <td style='vertical-align: top;'>
