...
*
* $Id: vitals.php 922 2005-11-06 02:58:02Z tim $
*/
...
function html_vitals () {
    ...
    $_text = '<table border="0" width="90%" align="center">'
           ...
           . '<tr><td valign="top"><font size="-1">'. $text['dversion'] .'</font></td><td><img width="16" height="16" alt="" src="extensions/SysInfo/images/' . $XPath->getData('/phpsysinfo/Vitals/Distroicon') .'">&nbsp;<font size="-1">' . $XPath->getData('/phpsysinfo/Vitals/Distro') . '</font></td></tr>'
