...
*
* $Id: common_functions.php 922 2005-11-06 02:58:02Z tim $
* HTML/XML Comment
*/
...
function create_bargraph ($percent, $a, $b, $type = "") {
  if ($percent == 0) {
    return '<img height="10" src="extensions/SysInfo/images/bar_left.gif" alt="">' . '<img src="extensions/SysInfo/images/bar_middle.gif" height="10" width="1" alt="">' . '<img src="extensions/SysInfo/images/bar_right.gif" height="10" alt="">';
  } else if (($percent < 90) || ($type == "iso9660")) {
    return '<img height="10" src="extensions/SysInfo/images/bar_left.gif" alt="">' . '<img src="extensions/SysInfo/images/bar_middle.gif" height="10" width="' . ($a * $b) . '" alt="">' . '<img height="10" src="extensions/SysInfo/images/bar_right.gif" alt="">';
  } else {
    return '<img height="10" src="extensions/SysInfo/images/redbar_left.gif" alt="">' . '<img src="extensions/SysInfo/images/redbar_middle.gif" height="10" width="' . ($a * $b) . '" alt="">' . '<img height="10" src="extensions/SysInfo/images/redbar_right.gif" alt="">';
  } 
} 
