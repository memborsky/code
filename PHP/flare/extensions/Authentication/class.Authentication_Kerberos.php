...
* to a KDC or Windows Domain Controller. There are
* other ways to connect to a Windows DC but this is
* the only currently supported method. Another method
...
* @copyright GPL
*/
class Authentication_Kerberos extends Authentication {
    /**
    ...
    */
    ...
    /**
    * Creates an instance of Authenication_Kerberos class
    *
    ...
    */
    public function login($username = 'guest', $password = '') {
        ...
        if (krb5_login($username, $password) !== KRB5_OK) {
