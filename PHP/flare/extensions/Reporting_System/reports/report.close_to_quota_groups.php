...
/**
* Creates graphs based on group quotas
*
* This particular report requires that the Groups
* extension be installed and running. If no groups
...
class close_to_quota_groups {
    ...
    */
    public function __construct() {
        ...
        */
        $this->__set("report_name", "close_to_quota_groups");

        /**
        * Set up description
        */
        $this->__set("report_desc", "Graphs top most groups who are close to their quota");
    ...
    */
    public function show() {
        ...
        $this->tpl->display('reports/close_to_quota_groups.tpl');
    }
    ...
    */
    public function run($top) {
        $sql = array (
            "mysql" => array(
                "count" => "SELECT group_name,quota_used FROM "._PREFIX."_group_info ORDER BY quota_used DESC LIMIT :1"
            )
        );
        ...
        */
        ...
        $Graph->add(Image_Graph::factory('title', array("Top $top Groups Who Are Close to Their Total Quota", 11)));
        ...
        */
        ...
        while ($row = $stmt1->fetch_assoc()) {
            ...
            */
            ...
            $Dataset->addPoint("$group", $quota_used);
