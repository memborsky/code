   ...
   --------------------------------------------------------------------
      ...
      BEGIN
         ...
         WHILE index <= how_many LOOP
            ...
            Ada.INTEGER_TEXT_IO.put(out_data, list_2(index).whole_number, 1);
   ...
   --------------------------------------------------------------------
       ...
       PROCEDURE search ( list_1 : IN OUT product; how_many : IN OUT INTEGER; part : IN INTEGER ) IS
      ...
      BEGIN
         ...
         FOR i IN 1 .. how_many LOOP
            ...
            Ada.TEXT_IO.put("""");
               ...
               Ada.TEXT_IO.put(""" product number with name """ & list_1(i).data(1 .. list_1(i).data_length) & """ was found in place """);
   ...
   --------------------------------------------------------------------
       ...
       PROCEDURE get_data ( list_1 : IN OUT product; how_many : IN OUT INTEGER ) IS
      ...
      ------
         ...
         -------------------------------------------------------------------------------------
            ...
            IF blank = TRUE THEN
               ...
               list_1(index).data(1..temlist_length) := temlist(1..temlist_length);
               list_1(index).data_length := temlist_length;
            
               FOR gotten IN 1 .. 5 LOOP
               
                  list_1(index).number := (list_1(index).number * 10) + (character'pos(char(gotten)) - 48);
               
               END LOOP;
            
               FOR git IN 1 .. 6 LOOP
               
                  list_1(index).whole_number := (list_1(index).whole_number * 10) + (character'pos(char(git)) - 48);
   ...
   --------------------------------------------------------------------
       ...
       PROCEDURE insert ( list_1 : IN OUT product; item_1 : IN INTEGER; item_2 : IN string; how_many : IN OUT INTEGER ) IS
   ...
   --------------------------------------------------------------------
       ...
       PROCEDURE insertion_sort ( list_1 : IN OUT product; how_many : IN OUT INTEGER ) IS
      ...
      BEGIN
         ...
         WHILE sorted < howmany LOOP
            ...
            insert ( list_1, list_1(sorted + 1).number, list_1(sorted + 1).data, sorted );
